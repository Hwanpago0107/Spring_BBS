package com.bbs.mvc.board.controller;
...
import com.bbs.mvc.board.service.BoardService;
...
public class BoardController {
	...
	public String edit(@Valid BoardVO boardVO, BindingResult result, int pwd, SessionStatus sessionStatus,
			Model model) {
		if (result.hasErrors()) {
			return "/board/edit";
		} else {
